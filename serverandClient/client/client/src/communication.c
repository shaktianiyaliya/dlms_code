...
///////////////////////////////////////**********************************?/////////////////////////
	...
	char data1[1024] = " Hello this message from DLMS client" ; 
	...
	if (client.sin_addr.s_addr == INADDR_NONE)
	{
        ...
        client.sin_addr = *(struct in_addr*)(void*)hostent->h_addr_list[0];

        };

   

	if ( connect ( connection->socket , ( struct sockaddr * ) &client , sizeof ( client ) ) < 0 )
	{
		perror ( " Connect failed " ) ;
		exit ( 1 ) ;
	}

	if ( send ( connection->socket , data1 , sizeof ( data1 ) , 0 ) < 0 )
	{
		perror ( " Send failed " ) ;
		exit ( 1 ) ;
	}
...
//////////////////////////////////////////**********************************/////////////////////////////
    ...
    //create socket.
    //con->socket = socket(AF_INET, SOCK_STREAM, IPPROTO_IP);
   ...
   //? add.sin_addr.s_addr = inet_addr(address);
    ...
    //ret = connect(con->socket, (struct sockaddr*) & add, sizeof(struct sockaddr_in));
...
///////////////////////////////////////////////////////////////////////////////??????????
//In entry parameters tell where read is started (Zero index) and how many items are read. 
...
///////////////////////////////////////////////////////////////////////////////////?????
//In range parameters tell starting and ending time. 
